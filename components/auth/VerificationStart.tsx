...
export default function VerificationNeededScreen() {
  const theme = {
    primary: '#6366F1',
    primaryLight: '#EEF2FF',
    text: '#1E293B',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full max-w-md mx-auto px-6">
        ...
        <div className="space-y-8">
          ...
          {/* WhatsApp Button */}
          <button
            className="w-full py-4 rounded-2xl flex items-center justify-center gap-3 text-white text-lg font-medium"
